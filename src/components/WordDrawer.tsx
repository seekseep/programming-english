        ...
        {word && (
          <div className="max-w-xl mx-auto w-full px-5 py-6 overflow-y-auto max-h-[80dvh]">
            ...
            <DrawerHeader className="p-0 mb-4 text-center">
              <DrawerTitle className="text-3xl font-black">{word.english}</DrawerTitle>
              <p className="text-lg font-bold text-muted">{word.japanese}</p>
            </DrawerHeader>
            ...
            <div className="space-y-4">
              ...
              {word.example_programming.body && (
                <div>
                  <p className="text-sm text-muted mb-1">
                    コード例（{word.example_programming.language}）
                  </p>
                  <CodeBlock
